...
WORK_CAROUSEL_SLIDES: list[StaticImageSlide] = [
    StaticImageSlide(
        ...
        1600,
        1127,
        "Cementne košuljice — mašinska ugradnja i izvedena podloga na objektu",
    ...
    StaticImageSlide(
        ...
        1200,
        1600,
        "Cementne košuljice na gradilištu — ugradnja na spratu",
    ...
    StaticImageSlide(
        ...
        1200,
        1519,
        "Površina cementnih košuljica nakon mašinske ugradnje",
    ...
    StaticImageSlide(
        ...
        1200,
        1523,
        "Cementne košuljice — pripremljena podloga u stambenom prostoru",
...
SERVICES_GALLERY_IMAGES: list[StaticImageSlide] = [
    StaticImageSlide(
        ...
        1200,
        1491,
        "Mašinsko doziranje mešavine za cementne košuljice",
    ...
    StaticImageSlide(
        ...
        1200,
        1504,
        "Nivelisane cementne košuljice u toku izvođenja",
    ...
    StaticImageSlide(
        ...
        1600,
        1118,
        "Široka površina izvedenih cementnih košuljica",
